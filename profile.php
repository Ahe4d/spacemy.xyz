            ...
            <div class="left">
                <div class="LeftHandUserInfo">
                    <?php
                        ...
                        ';
                            echo "<a class='contactbuttons' href='add.php?id=" . (int)$_GET['id'] . "'>Friend User</a>";
                            echo "<a style='float: right'class='contactbuttons' href='#?id=" . (int)$_GET['id'] . "'>Report User</a><br><br>";
                            echo '<center>Current Group: <b>' . $row['currentgroup'] . "</b><br>";
                            echo '<small><a href="https://spacemy.xyz/profile.php?id=' . (int)$_GET['id'] . '">' . 'https://spacemy.xyz/profile.php?id=' . (int)$_GET['id']  . '</a></small></center></div>';
                            $bio = $row['bio'];
